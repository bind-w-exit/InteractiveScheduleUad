    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FullContexts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FullContexts_StudentsGroups_StudentsGroupId",
                        column: x => x.StudentsGroupId,
                        principalTable: "StudentsGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FullContexts_TimeContexts_TimeContextId",
                        column: x => x.TimeContextId,
            ...
            migrationBuilder.CreateTable(
                name: "ScheduleLessonJunctions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LessonId = table.Column<int>(type: "integer", nullable: false),
                    FullContextId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleLessonJunctions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleLessonJunctions_FullContexts_FullContextId",
                        column: x => x.FullContextId,
                        principalTable: "FullContexts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleLessonJunctions_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FullContexts_StudentsGroupId_TimeContextId",
                table: "FullContexts",
                columns: new[] { "StudentsGroupId", "TimeContextId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FullContexts_TimeContextId",
                table: "FullContexts",
                column: "TimeContextId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleLessonJunctions_LessonId",
                table: "ScheduleLessonJunctions",
                column: "LessonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeContexts_LessonIndex_WeekDay_WeekIndex",
                table: "TimeContexts",
                columns: new[] { "LessonIndex", "WeekDay", "WeekIndex" },
                unique: true);
        }
